      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<TodoRecord>(
            stream: TodoRecord.getDocument(widget.docRef!),
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController2 ??=
                              TextEditingController(
                            text: columnTodoRecord.description,
                          ),
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              150.0, 0.0, 0.0, 0.0),
                          child: Text(
                            dateTimeFormat('d/M', columnTodoRecord.date!),
                            style: FlutterFlowTheme.of(context).bodyMedium,
                          ),
                        ),
                      ],
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await widget.docRef!.update(todoUpdateData);
                                },
                                text: 'Done',
                                icon: Icon(
